...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move GitIDE to the Applications folder?"
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move GitIDE to the Applications folder in your machine and restart the app."
