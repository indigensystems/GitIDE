...
export interface IBranchesState {
   ...
   * GitIDE and GitHub.com default to using 'main' as the default branch.
   *
   * GitIDE users are able to configure the `init.defaultBranch` Git
...
export interface IChangesState {
  ...
  /**
   * The latest GitIDE stash entry for the current branch, or `null`
